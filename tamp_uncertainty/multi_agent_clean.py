...
def main():
    ...
    # state
    s = EnvState(holding={ROBOTS[0]:[],ROBOTS[1]:[]},clean=[],
                obj_regions={MUG:REGIONS[0]},
    ...
    for step in range(100):
        ...
        if action.name == "no-op": # symk planning failure or goal state!
            bp = copy.deepcopy(b)
            observation = None
        else:
        ...
        while True: # till a feasible action is picked!
            ...
            for ac in next_actions:
                ...
                if args[0] == ROBOTS[1]:
                    ...
                    if name == "pick_action":
                        if s.obj_regions[args[1]]==args[2] and s.holding[args[0]]==[]:# check feasibility
                            while True:
                                print(ac)
                        ...
                        if args[1] in s.holding[args[0]]: # check feasibility
                            while True:
                                print(ac)
                        ...
                        if args[1] not in s.obj_regions.values(): # check feasibility
                            while True:
                                print(ac)
